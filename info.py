...
API_ID = int(environ.get('API_ID', '28974991'))
API_HASH = environ.get('API_HASH', '14bf079a0f4bb3171cfcf1d0419e998d')
BOT_TOKEN = environ.get('BOT_TOKEN', "6883962227:AAGjJrXgmMk7gyHDzfUpEeH3Mmz-Wxk7KLY")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6246905664').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001914992448').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://poonamsaxenabilgrami:dEyKnbY9dDd8nemz@cluster0.ufebjvx.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002065572280'))
...
URL = "https://demo-qv77.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://demo-qv77.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://demo-qv77.onrender.com/".format(FQDN)
else:
    URL = "https://demo-qv77.onrender.com/".format(FQDN)
